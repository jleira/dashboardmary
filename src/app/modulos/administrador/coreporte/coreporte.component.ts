...
@Component({
  selector: 'app-coreporte',
  templateUrl: './coreporte.component.html',
  styleUrls: ['./coreporte.component.css']
})
export class CoreporteComponent implements OnInit {
  ...
  reporte(){
    ...
    this.api.getdata('resportesformexcel/' + this.formid+ '/'+this.pregid + '/'+this.finicial+ '/'+this.ffinal).subscribe((items) => {
